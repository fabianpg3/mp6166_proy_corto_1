module vedic_mult_32x32_param_pipeline (
    input wire clk,
    input wire [31:0] op_a, op_b,
    output reg [63:0] mult_res
);
    localparam VEDIC_WIDTH = 32;
    ...
    vedic_mult_16x16_param_pipeline u0 (
        .clk(clk),
    ...
    vedic_mult_16x16_param_pipeline u1 (
        .clk(clk),
        .op_a(int_op_a[((VEDIC_WIDTH/2)-1):0]),
    ...
    vedic_mult_16x16_param_pipeline u2 (
        .clk(clk),
    ...
    vedic_mult_16x16_param_pipeline u3 (
        .clk(clk),
        .op_a(int_op_a[(VEDIC_WIDTH-1):(VEDIC_WIDTH/2)]),
        .op_b(int_op_b[(VEDIC_WIDTH-1):(VEDIC_WIDTH/2)]),
