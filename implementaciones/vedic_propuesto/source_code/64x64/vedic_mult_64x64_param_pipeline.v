module vedic_mult_64x64_param_pipeline (
    input wire clk,
    input wire [63:0] op_a, op_b,
    output reg [127:0] mult_res
);
    localparam VEDIC_WIDTH = 64;
    ...
    reg [VEDIC_WIDTH-1:0] int_op_a, int_op_b;
    wire [2*VEDIC_WIDTH-1:0] int_mult_res;
    ...
    vedic_mult_32x32_param_pipeline u0 (
        .clk(clk),
    ...
    vedic_mult_32x32_param_pipeline u1 (
        .clk(clk),
        .op_a(int_op_a[((VEDIC_WIDTH/2)-1):0]),
    ...
    vedic_mult_32x32_param_pipeline u2 (
        .clk(clk),
    ...
    vedic_mult_32x32_param_pipeline u3 (
        .clk(clk),
        .op_a(int_op_a[(VEDIC_WIDTH-1):(VEDIC_WIDTH/2)]),
        .op_b(int_op_b[(VEDIC_WIDTH-1):(VEDIC_WIDTH/2)]),
